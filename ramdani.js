...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© 𝙲𝙾𝙳𝙴-𝚇","listType": "SINGLE_SELECT","sections": list}}, {})
...
"externalAdReply": {
                ...
                "body": `${faketroli}`,
                "mediaType": "10",
                "mediaUrl": `https://www.instagram.com/reel/CbvBDvYJG5v/?utm_source=ig_web_copy_link`,
                "thumbnailUrl": "https://www.instagram.com/reel/CbvBDvYJG5v/?utm_source=ig_web_copy_link",
                "thumbnail": fakeimg,
                "sourceUrl": `https://www.instagram.com/reel/CbvBDvYJG5v/?utm_source=ig_web_copy_link`,
      ...
      const demoteAdmin = async function(to, target=[]){
          ...
          if (!packname) packname = 'Dibuat Oleh'; if (!author) author = '© 𝙲𝙾𝙳𝙴-𝚇';author = author.replace(/[^a-zA-Z0-9]/g, '');	
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/foto/thumb.jpg`)},"title": `© 𝙲𝙾𝙳𝙴-𝚇`,"description": "𝙲𝙾𝙳𝙴-𝚇", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "𝙲𝙾𝙳𝙴-𝚇","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
danzrun = process.uptime() 
           Ramdani.setStatus(`${namabot} Aktif ${(danzrun)} 🤖`).catch((_)=>_); //DI UBAH YATIMM
...
break
       ...
       if (isBanned) return freply(mess.banned)
        ...
        if (isBanned) return freply(mess.banned)
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: 'Owner ku hanya save nomor cewek😜',
               buttons: buttons,
               headerType: 1
}
...
🎟️ *Status* : ${isOwner ? 'Owner' : isPremium ? 'Premium' : 'Free use'}
...
×͜×━━━━━ *INFO USER* ━━━━━×͜×
メ NAMA : *${pushname}*
メ API : *wa.me/${sender.split('@')[0]}*
メ STATUS : *${isOwner ? 'Owner' : isPremium ? 'Premium' : 'Free use'}*
メ LIMIT : *${isPremium ? 'Unlimited' : `${limit}`}*

×͜×━━━━━ *INFO BOT* ━━━━━×͜×
メ NAMA : *${namabot}*
メ API : *wa.me/${botNumber}*
メ OWNER : *${namaowner}*
メ API : *wa.me/${nomorowner}*
メ AKTIF : *${runtime(process.uptime())}*
メ BATERAI : *${baterai}*
メ PREFIX : *『×͜× multi prefix ×͜×』*
メ TOTAL FITUR : *400+*
...
❏ 532 ${prefix}nsfw_avatar`
               ...
               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: '© 𝙲𝙾𝙳𝙴-𝚇', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
if (isBanned) return freply(mess.banned)
freply(`━━━━━ *SCRIPT* ━━━━━
メ LINK VIA GITHUB : https://github.com/
*━━━━━━━━━━━━━━━━━━━━*`)
break
case 'alllmenu2':
if (!isRegist) return freply(mess.regist)
...
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/6282230397507?text=bang+mau+order+jasa+run+heroku:v`)
break
//JASA UP HEROKU
case 'jasaupgithub':
case 'jasaup':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/6282230397507?text=bang+mau+order+jasa+up+github:v`)
break
//STORE MENU//
//TOP UP GAME
case 'topupgame2':
...
// SOSMET          
      ...
      if (!isRegist) return freply(mess.regist)
      if (isBanned) return freply(mess.banned)
             freply(`Follow Instagram Owner Ya : https://www.instagram.com/codex`)
             break
//casee nya
case 'grupbot':
case 'groupbot':
...
case 'tiktok':
              ...
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt 𝙲𝙾𝙳𝙴-𝚇\n Help 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan':
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI 𝙲𝙾𝙳𝙴-𝚇\`\`\`')
...
case 'ttp':
              if (!isRegist) return freply(mess.regist)
              if (isBanned) return freply(mess.banned)
              if (args.length == 0) return freply(`Example: ${prefix + command} 𝙲𝙾𝙳𝙴-𝚇`)
              woy = args.join(" ")
              freply(mess.wait)
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© 𝙲𝙾𝙳𝙴-𝚇* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
              if (!isRegist) return freply(mess.regist)
              if (isDewasa) return freply(mess.dewasa)
...
Ramdani.sendMessage(from, tapib1, document, { quoted: mek, filename:`𝙲𝙾𝙳𝙴-𝚇 ~ 404 ${danz}.mp3`, mimetype: 'audio/application' })
...
"groupInviteMessage": {
"groupJid": "6282230397507-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": "162533333338378",
"groupName": `𝙲𝙾𝙳𝙴-𝚇 ~ 404 ${danz}`,
...
"caption": "https://chat.whatsapp.com/HENlB7cJ7k1FyNRfi2ATJA",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
"businessOwnerJid": "6282230397507@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
              freply(`*FOLLOW IG Owner :*\n https://www.instagram.com/reel/CbvBDvYJG5v/?utm_source=ig_web_copy_link`)
              break
case 'y': 
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
...
//------------------< Lainnya >-------------------
      ...
      case 'caripesan':
       ...
       case 'bugreport':
              ...
              Ramdani.sendMessage('6282230397507@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
              if (!isRegist) return freply(mess.regist)
              if (isBanned) return freply(mess.banned)

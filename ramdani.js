...
danzrun = process.uptime() 
           Ramdani.setStatus(`${namabot} Aktif Selama ${(danzrun)} © Creator By 𝙲𝙾𝙳𝙴-𝚇`).catch((_)=>_); //DI UBAH YATIMM
